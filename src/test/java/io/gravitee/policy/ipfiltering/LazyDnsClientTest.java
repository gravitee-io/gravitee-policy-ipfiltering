...
public class LazyDnsClientTest {
    ...
    public void shouldResolveIPv4() {
        ...
        Future<List<String>> future = LazyDnsClient.lookup(executionContext, LookupIpVersion.IPV4, "example.com");
    ...
    public void shouldResolveIPv6() {
        ...
        Future<List<String>> future = LazyDnsClient.lookup(executionContext, LookupIpVersion.IPV6, "example.com");
    ...
    public void shouldResolveALL() {
        ...
        Future<List<String>> future = LazyDnsClient.lookup(executionContext, LookupIpVersion.ALL, "example.com");
